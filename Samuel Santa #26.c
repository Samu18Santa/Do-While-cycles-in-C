...
int main()
{
    ...
    int i = 1, j = 1, k = 1;
    do{
        while( j <= espaciosIniciales )//no se usa do-while porque no se necesita que se imprima al menos un espacio en la fila inicial
        {
            printf( " " );
            j++;
        }
        ...
        while( k <= espaciosMedios )//no se usa do-while porque no se necesita que se imprima al menos un espacio en la fila final
        {
            printf( " " );
            k++;
        }
